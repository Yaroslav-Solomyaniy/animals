  ...
  return (
    <main className="storybook-bg min-h-screen overflow-hidden text-text-main">
      ...
      <PageHero
        ...
        icon={BookOpen}
      >
        <div className="orange-neon relative overflow-hidden rounded-[24px] bg-gray-950">
          <img
            src={featuredAnimal.imageUrl}
            alt={featuredAnimal.name}
            className="h-[360px] w-full object-cover opacity-75"
          ...
          <div className="absolute bottom-6 left-6 right-6">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-1 text-xs font-extrabold text-text-main backdrop-blur">
      ...
      <section className="relative z-20 mx-auto -mt-10 max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
        <SectionFrame className="rounded-[28px] border-gray-100 p-4 sm:p-5">
          <div className="absolute -top-5 right-8 hidden h-20 w-9 rounded-b-xl bg-primary shadow-primary sm:block" />
          <div className="absolute -top-3 right-20 hidden h-14 w-8 rounded-b-xl bg-secondary/90 shadow-soft md:block" />
        ...
        <div className="mb-8 mt-12 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          {activeFiltersCount > 0 && (
            <button
              ...
              className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-2xl border border-gray-100 bg-white px-5 text-sm font-bold text-gray-500 transition-all hover:border-primary hover:text-primary sm:w-auto"
            >
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {currentAnimals.map((animal, index) => (
                <AnimalCard
                  ...
                  animal={animal}
                  index={index}
                  className="storybook-card shadow-soft"
                />
              ))}
            </div>
