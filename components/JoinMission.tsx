...
const JoinMission = () => {
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#1f6f50_0%,#12685f_56%,#f97316_150%)] px-5 py-5 text-white sm:px-6 sm:py-6 lg:px-8 lg:py-16">
      <span
        aria-hidden="true"
