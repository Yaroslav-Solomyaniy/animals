...
export default function Hero() {
  return (
    <section className="relative flex min-h-[calc(100vh-80px)] items-center overflow-hidden py-16 md:py-20">
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.46),rgba(249,250,251,0.32))]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="items-center lg:grid lg:grid-cols-2 lg:gap-16">
          ...
          >
            <div className="inline-flex max-w-full items-center gap-2 rounded-full bg-green-50 px-3 py-1 text-xs font-bold tracking-wider text-secondary uppercase">
              <span className="h-2 w-2 shrink-0 animate-pulse rounded-full bg-secondary"></span>
              <span className="truncate">
                За підтримки КП "Черкаська служба чистоти"
              </span>
            </div>
            ...
            <p className="max-w-xl text-xl leading-8 text-primary">
