...
const WelcomeCarousel = () => {
    ...
    return (
        <div
            ...
            <div
                className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,rgba(15,23,42,0.08)_52%,rgba(15,23,42,0.38)_100%)]"
            />
            ...
            <div className="relative z-10 grid h-full content-between p-4 sm:p-6 lg:p-8">
                ...
                <AnimatePresence mode="wait">
                    ...
                    <ActiveIcon className="h-5 w-5" />
                        ...
                        <h2 className="text-lg leading-tight font-black sm:text-[24px] lg:text-[26px]">
                            {activeSlide.title}
                        </h2>
                        <p className="mt-2 text-sm leading-5 font-bold text-gray-600 sm:mt-3 sm:text-[15px] sm:leading-6">
