  ...
  return (
    <header className="sticky top-0 z-50 px-0 py-0">
      <motion.nav
        initial={false}
        animate={{
          width: isCompact ? 'min(92vw, 84rem)' : '100%',
          ...
          boxShadow: isCompact ? '0 18px 60px rgba(15,23,42,0.12)' : '0 0 0 rgba(15,23,42,0)',
        }}
        transition={{
          duration: 0.26,
          ease: [0.22, 1, 0.36, 1],
      ...
      >
        ...
        >
          ...
          <div className="hidden items-center gap-3 lg:flex">
            <LinkButton href={SITE_ROUTES.help} size={isCompact ? 'sm' : 'md'}>
              Підтримати
            </LinkButton>
          </div>
        ...
        {isOpen && (
          ...
          >
            <div className="space-y-1.5 px-3 py-3">
              ...
              <div className="pt-2">
                <LinkButton href={SITE_ROUTES.help} onClick={() => setIsOpen(false)} size="lg" className="w-full">
                  Підтримати
                </LinkButton>
              </div>
            </div>
