...
const throttle = <Args extends Array<unknown>>(fn: (...args: Args) => void, limit: number) => {
  let lastCall = 0
...
export default function DotGrid({
  ...
  const dotsRef = useRef<Array<Dot>>([])
  ...
  return (
    <div ref={wrapperRef} className={`relative h-full w-full ${className}`} style={style}>
