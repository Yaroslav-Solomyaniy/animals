...
const helpInputClass = 'h-10 w-full rounded-xl px-4 py-0 text-sm font-bold leading-none sm:h-12'
...
const HelpUs = () => {
  ...
  return (
    <Section id="help" className="contacts-gradient-honey py-16 sm:py-20 lg:py-24">
      ...
      <div
        className={`grid items-stretch gap-5 sm:gap-6 lg:gap-6 xl:gap-8 ${donationsEnabled ? 'md:grid-cols-2 lg:grid-cols-3' : 'md:grid-cols-2'}`}
      >
        <CentreNeedList />
...
const CentreNeedList = () => {
  return (
    ...
    >
      <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-secondary/10 text-secondary transition-colors duration-300 group-hover:bg-secondary group-hover:text-white sm:mb-6 sm:h-14 sm:w-14">
        <Gift className="h-6 w-6 sm:h-7 sm:w-7" />
      </div>
      <h3 className="mb-3 text-xl font-bold text-text-main sm:text-2xl">Список необхідного</h3>
      <p className="mb-5 text-sm leading-6 text-gray-500 sm:mb-6 sm:leading-relaxed">
        Тваринам постійно потрібна підтримка. Актуальні речі можна уточнити телефоном або переглянути у повному списку необхідного.
      </p>
      ...
      <div className="mb-5 grid gap-3">
        <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
          ...
          <p className="text-sm leading-6 text-gray-500">Корм, ліки, засоби догляду та речі для комфорту тварин.</p>
        </div>
      </div>
      ...
      <LinkButton href={`${SITE_ROUTES.help}#necessary-things`} className={`mt-auto ${helpControlClass}`}>
...
const DonateForm = () => {
  ...
  return (
    ...
    >
      <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-white/20 transition-colors duration-300 group-hover:bg-white group-hover:text-primary sm:mb-6 sm:h-14 sm:w-14">
      ...
      <p className="mb-5 text-sm leading-6 text-white/80 sm:mb-6 sm:leading-relaxed lg:mb-8">
        Твій внесок допомагає забезпечити безпритульних тварин ліками, їжею та теплим прихистком.
      </p>
      ...
      <div className="mb-4 rounded-2xl border border-white/18 bg-white/10 p-4 text-xs leading-5 text-white/80 sm:mb-5 sm:text-sm sm:leading-6">
        <span className="mb-1 block font-black text-white">Куди піде допомога</span>
      ...
      <div className="relative mb-4 sm:mb-5">
        <span className="absolute top-1/2 left-4 -translate-y-1/2 text-sm font-bold text-white/50">₴</span>
        <input
          type="text"
      ...
      <div className="mb-4 flex items-end justify-between gap-3 rounded-2xl border border-white/25 bg-white/10 p-4 text-sm text-white shadow-sm backdrop-blur sm:mb-5 sm:block">
        ...
        <strong className="block shrink-0 text-xl font-black leading-none text-white sm:mt-1 sm:text-base">₴{activeDonationAmount}</strong>
      </div>
